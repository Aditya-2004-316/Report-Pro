...
function StudentRegistry({ theme }) {
    ...
    const responsiveStyleTag = (
        <style>{`
            ...
            /* Medium tablets and small desktops (768px to 1023px) */
            ...
            @media (max-width: 730px) {
                ...
                .registry-config-grid > div,
                .registry-add-row > div {
                    width: 100% !important;
                    box-sizing: border-box !important;
                }
                .registry-actions {
                ...
                /* Fix for overflow issue - ensure all elements stay within container */
                .registry-section,
                .registry-config,
                .registry-add,
                .registry-list {
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <div
                        className="registry-config-grid"
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                registry for <strong>{studentClass}</strong>{" "}
                                class, <strong>{session}</strong> session?
                                <br />
                                <span
                                    style={{
                                        color: "#f44336",
